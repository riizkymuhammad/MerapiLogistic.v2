...
<body class="theme-pink">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php?halaman=dashboard"><b>Merapi Logistik</b></a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <?php 
            $id=$_SESSION['kosong'];
            $query=mysqli_query($con,"select * from logposko where idlog='$id'");
            while($a=mysqli_fetch_array($query)) {
            ?>
            <div class="user-info">
                <div class="image">
        ...
        <!--isi-->
                    ...
                    <?php 
                         ...
                         switch($_GET['halaman'])
                        {
                            ...
                            case 'update-kebutuhan': include'update.php'; break;

                            case 'update-status': include'updatestatus.php'; break;
